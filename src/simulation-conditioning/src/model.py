...
class simulation_conditioning(object):
    def __init__(self, sess, args):
        ...
        self.file_name_trainA = os.path.join(args.data_path, 'Wavefield_Marmousi_401x301_combined_A_train.hdf5')
        self.file_name_trainB = os.path.join(args.data_path, 'Wavefield_Marmousi_401x301_combined_B_train.hdf5')
        self.file_name_testA  = os.path.join(args.data_path, 
            'Wavefield_Marmousi_401x301_500-1300_0-312_2k_40kp200_A_test.hdf5')
        self.file_name_testB  = os.path.join(args.data_path, 
            'Wavefield_Marmousi_401x301_500-1300_0-312_2k_40kp200_B_test.hdf5')

        if self.transfer==1:
            self.file_name_trainA = os.path.join(args.data_path, 
                'Wavefield_Marmousi_401x301_500-1300_0-312_20kp1_20kp220_A_train.hdf5')
            self.file_name_trainB = os.path.join(args.data_path, 
                'Wavefield_Marmousi_401x301_500-1300_0-312_20kp1_20kp220_B_train.hdf5')
