...
datasize0 = int(np.shape(range(0, shape[0], 20))[0])
datasize1 = int(np.shape(range(100, nt, 30))[0])
datasize = datasize0*datasize1


strTrainA = os.path.join(save_dir, 'Wavefield_Marmousi_pml_401x301_0-287_200-312_20k_30kp100_A_train.hdf5')
strTrainB = os.path.join(save_dir, 'Wavefield_Marmousi_pml_401x301_0-287_200-312_20k_30kp100_B_train.hdf5')
...
kk = 0
for xsrc in range(0, shape[0], 20):
