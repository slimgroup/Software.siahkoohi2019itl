...
from model import gradient_conditioning

parser = argparse.ArgumentParser(description='')
parser.add_argument('--experiment_dir', dest='experiment_dir', default='gradient', help='path of the dataset')
...
parser.add_argument('--image_size0', dest='image_size0', type=int, default=400, help='then crop to this size')
parser.add_argument('--image_size1', dest='image_size1', type=int, default=341, help='then crop to this size')
...
def main(_):
    ...
    with tf.Session(config=tfconfig) as sess:
        model = gradient_conditioning(sess, args)
