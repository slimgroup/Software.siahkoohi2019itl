...
class data_conditioning(object):
    def __init__(self, sess, args):
        ...
        self.file_name_trainA = os.path.join(args.data_path, 
            'MultipleElimination_Salt_A_1k_WaterDepth10_train_SourceDepth_Freq50.hdf5')
        self.file_name_trainB = os.path.join(args.data_path, 
            'MultipleElimination_Salt_B_1k_WaterDepth10_train_SourceDepth_Freq50.hdf5')
        self.file_name_testA  = os.path.join(args.data_path, 
            'MultipleElimination_Salt_A_1k_test_SourceDepth_Freq50.hdf5')
        self.file_name_testB  = os.path.join(args.data_path, 
            'MultipleElimination_Salt_B_1k_test_SourceDepth_Freq50.hdf5')
